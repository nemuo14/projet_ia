...
enc_haut_tot = encoding.fit_transform(new_data["haut_tot"])
enc_haut_tronc = encoding.fit_transform(new_data["haut_tronc"])
enc_diam_tronc = encoding.fit_transform(new_data["diam_tronc"])
enc_age_estim = encoding.fit_transform(new_data["age_estim"])
print(enc_age_estim)
